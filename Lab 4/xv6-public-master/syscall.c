...
extern int sys_change_queue_lvl(void);
extern int sys_set_HRRN(void);
extern int sys_set_all_HRRN(void);
...
[SYS_change_queue_lvl]    sys_change_queue_lvl,
[SYS_set_HRRN]    sys_set_HRRN,
[SYS_set_all_HRRN]    sys_set_all_HRRN,
